...
class Student:
    def __init__(self, root):
        ...
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,text="Department",font=("times new roman", 13, "bold"),width=17,state="readonly")
            ...
            try:
                ...
                if Update > 0:
                    ...
                    my_cursor.execute("update student set Dep=%s, Course=%s, Year=%s, Semester=%s, StudentId=%s, Name=%s, Section=%s, `Group`=%s, Gender=%s, DOB=%s, Email=%s, Phone=%s, Address=%s, Teacher=%s, PhotoSample=%s where StudentId=%s", (
                        ...
                        self.var_year.get(),
                        self.var_semester.get(),
                        self.var_id.get(),  # Correct StudentId
                        self.var_name.get(),
                        self.var_section.get(),
                        self.var_group.get(),
                        self.var_gender.get(),
    ...
    #                     self.var_teacher.get(),
    #                     self.var_radio1.get(),
    #                     self.var_id.get()==id+1  # Correct StudentId
    #                 ))
        ...
        if self.var_dep.get() == "Select Department" or self.var_name.get() == "" or self.var_id.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    # ✅ Fix: Update with correct StudentId
                    my_cursor.execute("""
